...
\subsection*{Summary}
\textit{This section covers a summary of the properties of the cryptographic primitives. What it can do, and how different it is from similar primitives. For instance, explicitly distinguishing threshold signatures from multi-signatures, from ATMs, etc.}
\subsection*{Generalised specification}
\textit{This section covers the specific instantiation as presented from the reference (either academic paper or standard).}
